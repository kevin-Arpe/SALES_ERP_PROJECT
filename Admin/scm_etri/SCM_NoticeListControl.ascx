                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="ctlNoticeList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="SCM_NewsID" HeaderText="번호" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" />
                                      

					  <asp:TemplateField HeaderText="TITLE">
                                            <ItemTemplate>
                                                <a href='SCM_NoticeView.aspx?SCM_NewsID=<%#Eval("SCM_NewsID") %>'>
