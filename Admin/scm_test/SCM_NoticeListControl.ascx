...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
			...
			<tr><td height="30" colspan=9 align=center bgcolor="#5D7B9D"><font color="#ffffff"><b>잡링크 프로젝트 알림</b></font></td></tr>
			    <tr><td height="40" align="center">
					  ...
					  <asp:TemplateField HeaderText="시험자">
                                            <ItemTemplate>
                                                <a href='SCM_NoticeView.aspx?SCM_ScoreID=<%#Eval("SCM_ScoreID") %>'>
                                                    <%#FuncCutStrng(Eval("tester"))%>
                                                    &nbsp;
						...
						<asp:TemplateField HeaderText ="합격여부">
                                <ItemTemplate>        
                                    <font style="text-align: center" color="<%#FuncCutStrng(Eval("Color"))%>"><b><%#FuncCutStrng(Eval("pf"))%></b></font>                             	                                 
                                </ItemTemplate>
