...
<td width="40%" class="tdd" align=left><b><asp:DropDownList ID="txtcompany1" runat="server">
...
<td class="tdd" align=left><asp:FileUpload ID="FileUpload1" runat="server" /></asp:FileUpload></td>
</tr>															
