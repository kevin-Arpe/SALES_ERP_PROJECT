...
<td align=left><b><asp:TextBox ID="txtproject" runat="server" Width="80%"></asp:TextBox> </b></td> 
<td bgcolor="#efefef" width="10%" align=center><b> 일자 </b></td>
<td  align=left><b><asp:TextBox ID="txtdate1"  class="auto-kal"  runat="server" Width="20%"></asp:TextBox></b>
</td></tr></table>
<br> 
...
<td  width="40%" align=left><b><asp:TextBox ID="txtcustomer" runat="server" Width="50%"></asp:TextBox>&nbsp;&nbsp;Code </b>
...
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 기간</b></td><td  width="40%" align=left><nobr><b><asp:TextBox ID="txtperiod1" runat="server"   width="30%"></asp:TextBox>개월  년 연간계약</td>
...
<td width="40%" align=left><nobr><asp:DropDownList ID="txttodo" runat="server">
...
<td width="40%" align=left><nobr><asp:TextBox ID="txttech"  runat="server"   width="90%"></asp:TextBox></td></tr>  
...
<td align=left><nobr>
<asp:TextBox ID="txtdueDate" runat="server"   width="20%" class="auto-kal"> </asp:TextBox> 
&nbsp;&nbsp;업체
...
<td width="40%" align=left valign=top><asp:TextBox ID="txtetc" runat="server" TextMode="MultiLine"  width="100%" Rows="30">
⊙ 고객 : 
⊙ 업무 :   
⊙ 언어 : 
⊙ 근무 : 
