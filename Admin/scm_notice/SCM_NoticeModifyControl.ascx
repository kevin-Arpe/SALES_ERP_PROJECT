...
<td     align=left><b><asp:TextBox ID="txtproject" runat="server" Width="40%"></asp:TextBox>공공 일반 금융 통신 보험 서비스 제조 국방 보건 프로젝트 </b></td>  

<td bgcolor="#efefef" width="10%" align=center><b> 일자 </b></td>
<td  align=left><b><asp:TextBox ID="txtdate1" runat="server" Width="50%" class="auto-kal"></asp:TextBox></b>
</td></tr></table>
<br>
...
<td  width="30%" align=left><b><asp:TextBox ID="txtcustomer" runat="server" Width="50%"></asp:TextBox></b>
Code </b>
...
<td width="50%" align=left valign=top rowspan=10><asp:TextBox ID="txtetc" runat="server" TextMode="MultiLine"  width="95%" Rows="30"></asp:TextBox></td></tr>
<tr>
...
<tr><td bgcolor="#efefef" width="10%" align=center><b> 기간 </b></td><td  align=left><b><asp:TextBox ID="txtperiod1" runat="server"   width="30%"></asp:TextBox>개월 년</td></tr>
<tr><td bgcolor="#efefef" width="10%" align=center><b> 언어 </b></td><td  align=left><b>

<asp:DropDownList ID="txtlanguage1" runat="server">
...
<tr><td bgcolor="#efefef" width="10%" align=center><b> 기술 </b></td><td  align=left><b><asp:TextBox ID="txttech" runat="server"   width="80%"></asp:TextBox></td></tr>

<tr><td bgcolor="#efefef" width="10%" align=center><b> 업무 </b></td><td  align=left><b>
<asp:DropDownList ID="txttodo" runat="server">
...
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 마감 </b></td><td  align=left><asp:TextBox ID="txtdueDate" runat="server"   width="20%" class="auto-kal"></asp:TextBox></asp:TextBox></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 업체 </b></td><td  align=left>
<asp:DropDownList ID="txtcompany" runat="server">
