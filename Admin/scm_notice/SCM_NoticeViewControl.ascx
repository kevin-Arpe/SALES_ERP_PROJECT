...
<tr height=30>
<td bgcolor="#efefef" width="10%" align=center><b> project </b></td>
<td     align=left><b><asp:Label class="text" ID="lblproject" runat="server"></asp:Label></b></td>  

<td bgcolor="#efefef" width="10%" align=center><b> 일자 </b></td>
<td  align=left><b><asp:Label class="text" ID="lbldate1" runat="server"></asp:Label></b>
</td></tr></table>
<br> 			
...
<td  width="30%" align=left><b><asp:Label class="text" ID="lblcustomer" runat="server"></asp:Label></b>&nbsp;&nbsp; Code <b><asp:Label ID="lblcode1" runat="server"></asp:Label></b></td>
<td bgcolor="#efefef" width="10%" align=center rowspan=8><b> 내용 </b></td>
<td width="50%" align=left valign=top rowspan=8><asp:Label class="text" ID="lbletc" runat="server"></asp:Label></td></tr>
<tr>
...
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 프로젝트 명 </b></td><td  align=left><b><asp:Label class="text" ID="lblperiod1" runat="server"></asp:Label></b></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 언어 </b></td><td  align=left><b><asp:Label class="text" ID="lbllanguage1" runat="server"></asp:Label></b></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 기술 </b></td><td  align=left><b><asp:Label class="text" ID="lbltech" runat="server"></asp:Label></b></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 업무 </b></td><td  align=left><b><asp:Label class="text" ID="lbltodo" runat="server"></asp:Label></b></td></tr>


<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 진행 </b></td><td   align=left><b><asp:Label class="text" ID="lblprogress1" runat="server"></asp:Label></b></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 마감 </b></td><td  align=left><b><asp:Label class="text" ID="lbldueDate" runat="server"></asp:Label></b></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 업체 </b></td><td  align=left><b><asp:Label class="text" ID="lblcompany" runat="server"></asp:Label></b></td></tr>
</table>
<%} else { %> 
<%} %>
<br>  
